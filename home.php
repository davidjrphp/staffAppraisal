...
<?php if ($_SESSION['login_type'] == 2) : ?>
  <div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="small-box bg-light shadow-sm border">
        <div class="inner">
          <h3><?php echo $conn->query("SELECT * FROM job_description")->num_rows; ?></h3>

          <p>Total Job Description</p>
        </div>
        <div class="icon">
    ...
    <div class="col-12 col-sm-6 col-md-4">
      <div class="small-box bg-light shadow-sm border">
        <div class="inner">
          <h3><?php echo $conn->query("SELECT * FROM work_plan")->num_rows; ?></h3>

          <p>Total Individual Work Plans</p>
        </div>
        <div class="icon">
