            ...
            <table class="table tabe-hover table-bordered" id="list">
                ...
                <tbody>
                    ...
                    if ($_SESSION['login_type'] == 1) :
                        $user = $conn->query("SELECT * FROM users where id in (SELECT user_id FROM documents´_list) ");
                    ...
                    $qry = $conn->query("SELECT * FROM document_list $where order by unix_timestamp(date_created) desc ");
